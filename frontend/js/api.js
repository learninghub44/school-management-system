/**
 * CBC School ERP — API Client v4.0
 * Reads window.API_BASE set by /js/config.js (loaded before this module)
 * Storage keys also from window.STORAGE_KEYS (config.js)
 */

// config.js must be loaded first — fallback keeps local dev working without it
...
export function getUser()   { return JSON.parse(sessionStorage.getItem(KEYS().USER) || "null"); }
